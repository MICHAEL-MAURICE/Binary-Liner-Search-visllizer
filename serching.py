...
class Initialization:
    def __init__(self,root):
        ...
        self.make_canvas = Canvas(self.window,bg="black",width=900,height=600,relief=RAISED)
        self.make_canvas.pack()

        heading = lambda: Label(self.make_canvas,text="Searching Algo Visualizer",font=("Arial",25,"bold","italic")).place(x=250,y=15)
        heading()
...
class Setup(Initialization):
    ...
    def __search_and_index_label_indicate(self):
        Label(self.make_canvas, text="Linear\nSearch", font=("Arial",30,"bold"), bg="black", fg="gold").place(x=40, y=150 + 50)
        Label(self.make_canvas, text="Binary\nSearch", font=("Arial", 30, "bold"), bg="black", fg="gold").place(x=40, y=150 + 50+250)

        Label(self.make_canvas, text="Index no.", font=("Arial", 13, "bold"), bg="black", fg="gold").place(x=70, y=150 + 10)
        Label(self.make_canvas, text="Index no.", font=("Arial", 13, "bold"), bg="black", fg="gold").place(x=70, y=150 + 10 + 250)

    def __two_array_maker(self):
        self.make_canvas.create_line(200, 150+50, 718+3, 150+50,width=3,fill="white")
        self.make_canvas.create_line(200, 206+50, 718+3, 206+50, width=3,fill="white")

        self.make_canvas.create_line(200, 450, 718 + 3, 450, width=3, fill="white")
        self.make_canvas.create_line(200, 506, 718 + 3, 506, width=3, fill="white")

    def __array_void_containers_and_index_maker(self):
        start_x=201
        Label(self.make_canvas,text="-1",font=("Arial",20,"bold"),bg="black",fg="white").place(x=start_x-52,y=203-50)
        Label(self.make_canvas,text="-1",font=("Arial",20,"bold"),bg="black",fg="white").place(x=start_x-52,y=453-50)
        for i in range(10):
           self.make_canvas.create_rectangle(start_x,203,start_x+50,253,width=3,outline="white")
           Label(self.make_canvas,text=(i+1)*10,font=("Arial",15,"bold",),bg="black",fg="white").place(x=start_x+10,y=203+10)

           # Up array index maker
           Label(self.make_canvas,text=i,font=("Arial",20,"bold"),bg="black",fg="white").place(x=start_x+15,y=203-50)
           
           self.make_canvas.create_rectangle(start_x,453,start_x+50,503,width=3,outline="white")
           Label(self.make_canvas,text=(i+1)*10,font=("Arial",15,"bold"),bg="black",fg="white").place(x=start_x+10,y=453+10)

           # Down array index maker
           Label(self.make_canvas,text=i,font=("Arial",20,"bold"),bg="black",fg="white").place(x=start_x+15,y=453-50)
    ...
    def __make_correct_wrong(self):
        ...
        self.pic_correct = Label(self.make_canvas,image=img_correct,bg="black")

        img_wrong = ImageTk.PhotoImage(Image.open("Images/wrong.png").resize((30, 30), Image.ANTIALIAS))
        self.pic_wrong = Label(self.make_canvas, image=img_wrong, bg="black")
    ...
    def __steps_label(self):
        ...
        self.step_linear = Label(self.make_canvas,text="Steps: "+ str(self.binary_step_counter),font=("Arial",20,"bold"),bg="black",fg="gold")
        self.step_linear.place(x=750,y=210)

        self.step_binary = Label(self.make_canvas, text="Steps: " + str(self.linear_step_counter), font=("Arial", 20, "bold"), bg="black", fg="gold")
...
class Functionality(Setup):
    ...
    def __introduction_btn(self):
        self.search_val_btn = Button(self.window, text="Search a value", font=("Arial", 25, "bold"), bg="black", fg="white", relief=RAISED, bd=7, command=self.__entry_take_forward)
        self.search_val_btn.place(x=50, y=618)

        self.reset_btn = Button(self.window, text="Reset", font=("Arial", 25, "bold"), bg="black", fg="white", relief=RAISED, bd=7, command=self.__reset_all, state=DISABLED)
        self.reset_btn.place(x=700, y=618)

    # Take entry from user and forward
    def __entry_take_forward(self):
        self.search_value_take = Entry(self.window, font=("Arial", 25, "bold", ), fg="black", relief=SUNKEN, bd=7, width=5)
        self.search_value_take.place(x=350, y=630)

        self.search_value_take.focus()

        self.search_val_activation = Button(self.window, text="Search Value", font=("Arial", 18, "bold",), bg="black", fg="white", relief=RAISED, bd=5, command=self.__give_searching_control)
    ...
    def __give_searching_control(self):
        try:
            ...
            if 9>=self.search_position_linear>=0:
                ...
                self.linear_conformation = Label(self.make_canvas,text="Found",font=("Arial",20,"bold"),bg="black",fg="green")
                ...
                self.window.update()
                self.linear_conformation = Label(self.make_canvas, text="Not found searching value in this array", font=("Arial", 20, "bold"), bg="black", fg="red")
            ...
            if self.start_binary<=self.end_binary:
                self.pic_correct.place_forget()
                self.binary_conformation = Label(self.make_canvas,text="Found",font=("Arial",20,"bold"),bg="black",fg="green")
                ...
                self.binary_conformation = Label(self.make_canvas, text="Not found searching value", font=("Arial", 20, "bold"), bg="black", fg="red")
